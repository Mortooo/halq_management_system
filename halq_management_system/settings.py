"""
Django settings for halq_management_system project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-!plj_+$)=g5wa%^r$_1!9zllg@$1icnj5x9#ke4wvss-d7n=uc')
...
WSGI_APPLICATION = 'halq_management_system.wsgi.application'
...
# LOGIN_REDIRECT_URL = 'administration_dashboard'       # where to go after login
LOGOUT_REDIRECT_URL = '/'      # where to go after logout

ACCOUNT_EMAIL_VERIFICATION = "none"  # can be "mandatory"
ACCOUNT_LOGIN_METHODS = {"username"}
ACCOUNT_SIGNUP_FIELDS = ["email*", "username*", "password1*", "password2*"]
ACCOUNT_ADAPTER = 'halq_management_system.adapter.MyAccountAdapter'
